...
1.Start the program and read the value of N.

2.Place queens column by column using recursion.

3.Check if the current position is safe,if safe, place the queen and recursively place the rest; if not, backtrack.
